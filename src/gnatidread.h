...
char dataDir[] = "assets";  // Stores the path to the models-textures folder.
...
char objectMenuEntries[numMeshes][128] = {
  ...
  "51 Chef", "52 Parasaurolophus", "53 Rooster", "54 T-rex", "55 Sphere", "56 Monkey", "57 Gingerbread Man"
};
